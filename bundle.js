...
const shader = require("kindred-shader/raw")("precision highp float;\n#define GLSLIFY 1\n\n  attribute vec2 position;\n  uniform float time;\n  uniform vec2 shape;\n\n  void vert() {\n    gl_Position = vec4(position, 1, 1);\n  }\n\n  void main () { vert(); }","precision highp float;\n#define GLSLIFY 1\n\n  uniform float time;\n  uniform vec2 shape;\n\n  vec2 squareFrame(vec2 screenSize, vec2 coord) {\n  vec2 position = 2.0 * (coord.xy / screenSize.xy) - 1.0;\n  position.x *= screenSize.x / screenSize.y;\n  return position;\n}\n\n  void frag() {\n    vec2 uv = squareFrame(shape, gl_FragCoord.xy);\n\n    gl_FragColor = vec4(fract(uv * 3. + time), sin(time), 1);\n  }\n\nvoid main () { frag(); }").bind(gl)
...
},{"a-big-triangle":19,"canvas-fit":27,"kindred-shader/raw":33}],2:[function(require,module,exports){
"use strict"
...
},{"bit-twiddle":11,"buffer":23,"dup":12}],14:[function(require,module,exports){
"use strict"
...
},{"pad-left":21}],21:[function(require,module,exports){
/*!
...
},{"repeat-string":22}],22:[function(require,module,exports){
/*!
...
},{"dup":30,"gl-shader-extract":31}],30:[function(require,module,exports){
...
},{"add-line-numbers":20,"gl-magic-uniforms":29,"gl-shader-extract":31}]},{},[1]);
